...
/* Private defines -----------------------------------------------------------*/
#define Hall_M1_A_Pin GPIO_PIN_2
#define Hall_M1_A_GPIO_Port GPIOE
#define Hall_M1_B_Pin GPIO_PIN_3
#define Hall_M1_B_GPIO_Port GPIOE
#define Hall_M2_A_Pin GPIO_PIN_4
#define Hall_M2_A_GPIO_Port GPIOE
#define Hall_M2_B_Pin GPIO_PIN_5
#define Hall_M2_B_GPIO_Port GPIOE
#define Hall_M3_A_Pin GPIO_PIN_6
#define Hall_M3_A_GPIO_Port GPIOE
...
#define Sensor_Left_Trig_Pin GPIO_PIN_2
#define Sensor_Left_Trig_GPIO_Port GPIOA
#define Sensor_Front_Trig_Pin GPIO_PIN_3
#define Sensor_Front_Trig_GPIO_Port GPIOA
#define Sensor_Back_Trig_Pin GPIO_PIN_4
#define Sensor_Back_Trig_GPIO_Port GPIOA
...
#define Hall_M3_B_Pin GPIO_PIN_7
#define Hall_M3_B_GPIO_Port GPIOE
#define Sensor_Front_Echo_Pin GPIO_PIN_8
#define Sensor_Front_Echo_GPIO_Port GPIOE
#define M3PWM_Pin GPIO_PIN_9
#define M3PWM_GPIO_Port GPIOE
#define Sensor_Back_Echo_Pin GPIO_PIN_10
#define Sensor_Back_Echo_GPIO_Port GPIOE
#define M4PWM_Pin GPIO_PIN_11
#define M4PWM_GPIO_Port GPIOE
#define Sensor_Left_Echo_Pin GPIO_PIN_12
#define Sensor_Left_Echo_GPIO_Port GPIOE
#define M2PWM_Pin GPIO_PIN_13
#define M2PWM_GPIO_Port GPIOE
#define Sensor_Right_Echo_Pin GPIO_PIN_14
#define Sensor_Right_Echo_GPIO_Port GPIOE
...
#define Hall_M4_A_Pin GPIO_PIN_3
#define Hall_M4_A_GPIO_Port GPIOD
...
#define Hall_M4_B_Pin GPIO_PIN_7
#define Hall_M4_B_GPIO_Port GPIOD
