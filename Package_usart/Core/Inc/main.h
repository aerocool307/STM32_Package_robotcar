...
/* Private defines -----------------------------------------------------------*/
#define M2HALLA_Pin GPIO_PIN_2
#define M2HALLA_GPIO_Port GPIOE
#define M2HALLB_Pin GPIO_PIN_3
#define M2HALLB_GPIO_Port GPIOE
#define M3HALLA_Pin GPIO_PIN_4
#define M3HALLA_GPIO_Port GPIOE
#define M3HALLB_Pin GPIO_PIN_5
#define M3HALLB_GPIO_Port GPIOE
#define M4HALLA_Pin GPIO_PIN_6
#define M4HALLA_GPIO_Port GPIOE
#define USER_Btn_Pin GPIO_PIN_13
#define USER_Btn_GPIO_Port GPIOC
#define LORA_RX_Pin GPIO_PIN_6
#define LORA_RX_GPIO_Port GPIOF
#define LORA_TX_Pin GPIO_PIN_7
#define LORA_TX_GPIO_Port GPIOF
...
#define M1HALLA_Pin GPIO_PIN_0
#define M1HALLA_GPIO_Port GPIOG
#define M1HALLB_Pin GPIO_PIN_1
#define M1HALLB_GPIO_Port GPIOG
#define M4HALLB_Pin GPIO_PIN_7
#define M4HALLB_GPIO_Port GPIOE
